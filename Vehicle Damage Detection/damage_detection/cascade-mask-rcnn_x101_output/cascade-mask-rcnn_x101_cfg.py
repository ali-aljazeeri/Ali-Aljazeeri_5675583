...
launcher = 'none'
load_from = 'drive/MyDrive/damage_detection/cascade-mask-rcnn_x101_output/epoch_24_weights_only.pth'
log_level = 'INFO'
...
work_dir = './drive/MyDrive/damage_detection/cascade-mask-rcnn_x101_output'
